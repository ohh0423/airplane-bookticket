 ...
 * 基于数据库操作的自定义 Realm
 */
public class DbRealm111 extends AuthorizingRealm {

    @Autowired
    private UserService userService;

    public static final Logger logger= LoggerFactory.getLogger(DbRealm111.class);
    @Override
